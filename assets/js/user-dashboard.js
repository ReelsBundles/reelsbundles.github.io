            ...
            if (mainEl) {
                mainEl.innerHTML = `
                    ...
                    ">
                        ...
                        <h2 style="font-size: 22px; font-weight: 800; color: #f87171; margin-bottom: 12px;">ACCOUNT BANNED</h2>
                        <p style="color: #cbd5e1; font-size: 15px; font-weight: 500; line-height: 1.6; margin-bottom: 24px;">
                            ${escapeHtml(reason)}
                        </p>
                        <div style="
